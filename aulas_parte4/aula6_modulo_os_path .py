...
# pwd - No terminar permite ver o caminho que estou

import os

#Pegando um caminho de arquivo, para funcionar em qualquer S.O.
caminho = os.path.join('Desktp', 'Documento', 'Programação', 'arquivo.py')
print(caminho)
# Separando o diretório e o caminho do arquivo
diretorio, arquivo = os.path.split(caminho)

#Separando o arquivo e sua extensão
nome_arquivo, extensao_arquivo = os.path.splitext(arquivo)
print(nome_arquivo, extensao_arquivo)
print(arquivo)

# Verifica se um caminho existe
print(os.path.exists("C:\\Users\\victo\\OneDrive\\Documentos\\Programação"))

#Vendo o meu caminho absoluto
print(os.path.abspath('.'))

# Retornando a parte final do meu caminho
print(os.path.basename(caminho))

# Retornando o caminho do diretorio, sem o arquivo 
